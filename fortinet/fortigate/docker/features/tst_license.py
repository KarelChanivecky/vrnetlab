        ...
        if tst_license_enabled():
            blocks = [
                ...
                ConfigBlock("system fortiguard", [
                    CommandSpec("set fortiguard-anycast-source debug"),
                    CommandSpec("set fortiguard-anycast disable"),
                    CommandSpec("set interface-select-method specify"),
                    CommandSpec("set interface port1"),
                    CommandSpec("set auto-join-forticloud disable"),
                ]),
            ]
